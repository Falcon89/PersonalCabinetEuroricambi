                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" name="date" value="${news.date}">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>Фото</label>
                                                <input type="text" class="form-control border-input" name="fotonews" value="${news.fotonews}">
                                            </div>
                                        </div>
                                    </div>
